...
public class OpdList implements Parcelable
{
    ...
    public final static Creator<OpdList> CREATOR = new Creator<OpdList>() {
    ...
    protected OpdList(Parcel in) {
        ...
        in.readList(this.schedule, (com.ibt.niramaya.modal.doctor_opd_model.Schedule.class.getClassLoader()));
