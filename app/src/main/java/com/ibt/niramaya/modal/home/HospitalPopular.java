...
public class HospitalPopular implements Parcelable
{
...
public final static Parcelable.Creator<HospitalPopular> CREATOR = new Creator<HospitalPopular>() {


@SuppressWarnings({
"unchecked"
})
public HospitalPopular createFromParcel(Parcel in) {
return new HospitalPopular(in);
}

public HospitalPopular[] newArray(int size) {
return (new HospitalPopular[size]);
}

}
;

protected HospitalPopular(Parcel in) {
