...
@SerializedName("pharmacy_bill_medicine")
@Expose
private List<PharmacyBillMedicine> pharmacyBillMedicine = new ArrayList<PharmacyBillMedicine>();
...
in.readList(this.pharmacyBillMedicine, (com.ibt.niramaya.modal.invoice_modal.pharmacy_invoice_modal.PharmacyBillMedicine.class.getClassLoader()));
...
public List<PharmacyBillMedicine> getPharmacyBillMedicine() {
return pharmacyBillMedicine;
}

public void setPharmacyBillMedicine(List<PharmacyBillMedicine> pharmacyBillMedicine) {
this.pharmacyBillMedicine = pharmacyBillMedicine;
}
...
dest.writeList(pharmacyBillMedicine);
