...
public class SystemSpecialization implements Parcelable {
    ...
    public final static Parcelable.Creator<SystemSpecialization> CREATOR = new Creator<SystemSpecialization>() {


        @SuppressWarnings({
                "unchecked"
        })
        public SystemSpecialization createFromParcel(Parcel in) {
            return new SystemSpecialization(in);
        }

        public SystemSpecialization[] newArray(int size) {
            return (new SystemSpecialization[size]);
        }

    };

    protected SystemSpecialization(Parcel in) {
