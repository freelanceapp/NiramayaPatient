...
public class PrescriptionAdvisedListAdapter extends RecyclerView.Adapter<PrescriptionAdvisedListAdapter.MyViewHolder> {
    ...
    private ArrayList<PTAdvisedModel> prescriptionList;
    private Context mContext;

    public PrescriptionAdvisedListAdapter(ArrayList<PTAdvisedModel> pastHistoryList, Context mContext) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        PTAdvisedModel prescriptionModel = prescriptionList.get(position);
